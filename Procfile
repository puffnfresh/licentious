...
#     echo '{ "name": "licentious", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/licentious/licentious
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/licentious/licentious production -p $PORT
